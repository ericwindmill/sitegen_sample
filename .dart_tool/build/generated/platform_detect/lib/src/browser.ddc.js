define(['dart_sdk', 'packages/pub_semver/pub_semver'], function(dart_sdk, packages__pub_semver__pub_semver) {
  'use strict';
  ...
  var BrowserLToboolL = () => (BrowserLToboolL = dart.constFn(dart.fnType(core.bool, [browser$.Browser])))();
  var VoidToBrowserL = () => (VoidToBrowserL = dart.constFn(dart.fnType(browser$.Browser, [])))();
  var JSArrayOfBrowserL = () => (JSArrayOfBrowserL = dart.constFn(_interceptors.JSArray$(browser$.Browser)))();
  var NavigatorProviderLToboolL = () => (NavigatorProviderLToboolL = dart.constFn(dart.fnType(core.bool, [navigator.NavigatorProvider])))();
  var NavigatorProviderLToVersionL = () => (NavigatorProviderLToVersionL = dart.constFn(dart.fnType(version.Version, [navigator.NavigatorProvider])))();
  ...
  var JSArrayOfOperatingSystemL = () => (JSArrayOfOperatingSystemL = dart.constFn(_interceptors.JSArray$(operating_system.OperatingSystem)))();
  const CT = Object.create(null);
  var L1 = "package:platform_detect/src/browser.dart";
  var L0 = "package:platform_detect/src/navigator.dart";
  var L2 = "package:platform_detect/src/operating_system.dart";
  dart.defineLazy(CT, {
    get C0() {
  ...
  dart.setLibraryUri(navigator.NavigatorProvider, L0);
  ...
  dart.setLibraryUri(navigator.TestNavigator, L0);
  dart.setFieldSignature(navigator.TestNavigator, () => ({
    __proto__: dart.getFields(navigator.TestNavigator.__proto__),
    vendor: dart.fieldType(core.String),
    appVersion: dart.fieldType(core.String),
  ...
  browser$.Browser = class Browser extends core.Object {
    ...
    static getCurrentBrowser() {
      return browser$.Browser._knownBrowsers[$firstWhere](dart.fn(browser => {
        let t1, t0;
        return core.bool.as((t0 = browser, t1 = browser$.Browser.navigator, dart.dsend(t0, _matchesNavigator, [t1])));
    ...
    get version() {
      ...
      if (this[_version] == null) {
        if (this[_parseVersion] != null) {
          this[_version] = version.Version.as((t0 = browser$.Browser.navigator, dart.dsend(this, _parseVersion, [t0])));
        } else {
  ...
  dart.setGetterSignature(browser$.Browser, () => ({
    ...
    isFirefox: core.bool,
    isSafari: core.bool,
    isInternetExplorer: core.bool,
    isWKWebView: core.bool
  }));
  dart.setLibraryUri(browser$.Browser, L1);
  dart.setFieldSignature(browser$.Browser, () => ({
    ...
    [_matchesNavigator]: dart.finalFieldType(core.Function),
    [_parseVersion]: dart.finalFieldType(core.Function),
    [_version]: dart.fieldType(version.Version)
  }));
  ...
  dart.setLibraryUri(browser$._Chrome, L1);
  var C2;
  var C3;
  ...
  dart.setLibraryUri(browser$._Firefox, L1);
  var C4;
  var C5;
  ...
  dart.setLibraryUri(browser$._Safari, L1);
  var C6;
  var C7;
  ...
  dart.setLibraryUri(browser$._WKWebView, L1);
  var C8;
  var C9;
  ...
  dart.setLibraryUri(browser$._InternetExplorer, L1);
  ...
  operating_system.OperatingSystem = class OperatingSystem extends core.Object {
    ...
    static getCurrentOperatingSystem() {
      return operating_system.OperatingSystem._knownSystems[$firstWhere](dart.fn(system => {
        let t1, t0;
        return core.bool.as((t0 = system, t1 = operating_system.OperatingSystem.navigator, dart.dsend(t0, _matchesNavigator$, [t1])));
      }, OperatingSystemLToboolL()), {orElse: dart.fn(() => operating_system.OperatingSystem.UnknownOS, VoidToOperatingSystemL())});
    }
    get isLinux() {
  ...
  dart.defineLazy(operating_system.OperatingSystem, {
    ...
    /*operating_system.OperatingSystem._knownSystems*/get _knownSystems() {
      return JSArrayOfOperatingSystemL().of([operating_system.mac, operating_system.windows, operating_system.linux, operating_system.unix]);
    },
    set _knownSystems(_) {}
  }, true);
  dart.defineLazy(operating_system, {
    /*operating_system.linux*/get linux() {
      return new operating_system.OperatingSystem.new("Linux", dart.fn(navigator => navigator.appVersion[$contains]("Linux"), NavigatorProviderLToboolL()));
    },
    set linux(_) {},
    /*operating_system.mac*/get mac() {
      return new operating_system.OperatingSystem.new("Mac", dart.fn(navigator => navigator.appVersion[$contains]("Mac"), NavigatorProviderLToboolL()));
    },
    set mac(_) {},
    /*operating_system.unix*/get unix() {
      return new operating_system.OperatingSystem.new("Unix", dart.fn(navigator => navigator.appVersion[$contains]("X11"), NavigatorProviderLToboolL()));
    },
    set unix(_) {},
    /*operating_system.windows*/get windows() {
      return new operating_system.OperatingSystem.new("Windows", dart.fn(navigator => navigator.appVersion[$contains]("Win"), NavigatorProviderLToboolL()));
    },
    set windows(_) {}
  }, true);
