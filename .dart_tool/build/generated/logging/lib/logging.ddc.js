define(['dart_sdk'], function(dart_sdk) {
  ...
  var UnmodifiableMapViewOfStringL$LoggerL = () => (UnmodifiableMapViewOfStringL$LoggerL = dart.constFn(collection.UnmodifiableMapView$(core.String, logger.Logger)))();
  var VoidToLoggerL = () => (VoidToLoggerL = dart.constFn(dart.fnType(logger.Logger, [])))();
  var IdentityMapOfStringL$LoggerL = () => (IdentityMapOfStringL$LoggerL = dart.constFn(_js_helper.IdentityMap$(core.String, logger.Logger)))();
  var StreamControllerOfLogRecordL = () => (StreamControllerOfLogRecordL = dart.constFn(async.StreamController$(log_record.LogRecord)))();
  const CT = Object.create(null);
  var L1 = "file:///private/var/folders/7w/q7gbtlmj7jd5j1gvyhp2p8880000gn/T/scratch_space5vCb0r/packages/logging/src/logger.dart";
